...
import { FaChartLine, FaChartBar, FaChartPie, FaUserCheck, FaUserTimes, FaRegClock, FaInfoCircle, FaGlobe, FaCheck, } from "react-icons/fa";
...
const PerformanceMetrics = ({ stats }) => {
    ...
    return (<motion.div className={styles.metricsDashboard} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
      ...
      <div className={styles.metricsGrid}>
        {[
            ...
            },
            {
                ...
                trend: `${((displayStats.true_predictions / displayStats.total_predictions) *
            ...
            },
            {
                ...
                trend: `${((displayStats.fake_predictions / displayStats.total_predictions) *
        ...
        ].map((metric, index) => (<motion.div key={index} className={`${styles.metricCard} ${metric.className}`} whileHover={{ y: -3 }} transition={{ type: "spring", stiffness: 300 }}>
        ...
        ].map((method, index) => (<div key={index} className={styles.chartBar} style={{
                width: `${(method.value / displayStats.total_predictions) * 100}%`,
            }}>
                <span>
        ...
        <motion.div className={styles.metricChart} whileHover={{ scale: 1.005 }}>
          ...
          <div className={styles.donutChart}>
            ...
            "--total": displayStats.feedback_stats.correct +
            ...
            <div className={styles.donutCenter}>
              <div>
                {Math.round((displayStats.feedback_stats.correct /
